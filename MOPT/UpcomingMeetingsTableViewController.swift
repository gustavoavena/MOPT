...
//import UIKit
//
//class UpcomingMeetingsTableViewController: UITableViewController {
//	
//	// TODO: merge with MeetingsTableViewController
//	
//    
...
//        
//        cell.meetingName.text = meetings[indexPath.row].meetingName
//        cell.meetingDate.text = dateFormatter.string(from:meetings[indexPath.row].meetingDate)
//        cell.meetingTime.text = timeFormatter.string(from:meetings[indexPath.row].meetingDate)
//
//        return cell
//    }
//    
